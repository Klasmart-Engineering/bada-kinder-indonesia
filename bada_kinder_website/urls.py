...
urlpatterns = [
    ...
    path("rpp/<int:level_id>", views.rpp, name="rpp"),
    path("activity-book/<int:level_id>", views.activity_book, name="activity_book"),
    path("story-book/<int:level_id>", views.story_book, name="story_book"),
    path("course-book/<int:level_id>", views.course_book, name="course_book"),
